...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="collapse navbar-collapse" id="navbarColor01">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                <a class="nav-link text-white"> Welcome:  </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ url('login') }}"> Login </a>
                <!-- <span><a class="nav-link" href="{{ url('login') }}"> Login </a></span> -->
            </li>
        </ul>
    </div>
    @endif
...
<div class="page-wrapper">
    ...
    <div class="page-breadcrumb">
        <!-- <div class="form-group">
            <div class="col-md-2 mb-6 right">
                <a href="{{route('login')}}"><button type="button" class="btn btn-success btn-lg float-rightside">Login</button></a>
            </div>
        </div> -->
        <!-- <div class="form-group">
            <div class="col-md-2 mb-6 right">
                <a href="{{route('login')}}"><button type="button" class="btn btn-success btn-lg float-rightside">Logout</button></a>
            </div>
        </div> -->
            ...
            <div class="col-lg-4 col-xlg-3">
                ...
                <div class="card">
                    ...
                    <div class="card-body little-profile text-center">
                        ...
                        <p>Total Student &amp; College Registration</p>
                        <a href="javascript:void(0)" class="mt-2 waves-effect waves-dark btn btn-primary btn-md btn-rounded">Counting</a>
                        <div class="row text-center mt-3">
                            <div class="col-lg-4 col-md-4 mt-3">
                                <h3 class="mb-0 font-light">{{$student}}</h3><small>Student</small>
                            </div>
                            <div class="col-lg-4 col-md-4 mt-3">
                                <h3 class="mb-0 font-light">{{$college}}</h3><small>College</small>
                            </div>
