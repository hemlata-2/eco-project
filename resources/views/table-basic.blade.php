                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mx-auto pull-right">
                                    <div class="">
                                        {{-- <form action="{{ route('search_user') }}" method="POST" role="search">
                                            @csrf
                                    ...
                                    <table class="table user-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ ('uploadimage/' . $value->image) }}" width="100" height="100" />
                                                </td>
                                                @endif
                                                <!-- <td>{{$value->password}}</td> -->
                                                <td><a href="{{route('edituser', $value->id)}}"><button type="button" class="btn-info">Edit</button></a></td>

                                                <td><a href="{{route('delete', $value->id)}}"><button type="button" Onclick="return ConfirmDelete();" class="btn btn-danger d-inline-block">Delete</button></a></td>
